...
${HL_COMPOSER_CLI} network start  --card PeerAdmin@hlfv1  -A admin -S adminpw  --file "${DIR}"/_local/admin.card --networkName ${NETWORK_NAME} --networkVersion ${NETWORK_VERSION}
